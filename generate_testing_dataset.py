...
def generate_test_data(n=1, plot = False): 
    ...
    for i in range(n):
        ...
        phases = [0+random.uniform(-noise_phase, noise_phase), np.pi/2+random.uniform(-noise_phase, noise_phase), np.pi+random.uniform(-noise_phase, noise_phase)]  # Different phases for the 3 joints
